  ...
  widget.innerHTML = `
    ...
    <div id="fb-window" role="dialog" aria-label="ForexBot">
      ...
      <div id="fb-gate">
        ...
        <div class="fb-gate-title">Accède à Forex Average Bot Gratuitement</div>
        <div class="fb-gate-sub">
          Pose toutes tes questions sur le <strong>Forex, les Matières Premières, les Crypto</strong>, l'Analyse Technique et les Fondamentaux — réponses instantanées par IA.
        </div>
