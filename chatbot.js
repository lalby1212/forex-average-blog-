  ...
  async function sendMessage(message) {
    ...
    try {
      ...
      addMessage("bot",
        ...
        <a href="${CONFIG.LINKS.telegram_free}" target="_blank" rel="noopener noreferrer" class="fa-cta-btn fa-cta-btn--green">📱 Telegram Gratuit</a>
        <a href="${CONFIG.LINKS.telegram_vip}" target="_blank" rel="noopener noreferrer" class="fa-cta-btn fa-cta-btn--gold">💎 Telegram VIP</a>
        <span class="fa-legal">⚠️ Le trading comporte des risques de perte en capital.</span>`,
        true
      );
    }
