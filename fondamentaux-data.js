/* ── DATA G10 — Mise à jour 7 Juillet 2026 ── */
let CURR = [
  {
    code:'USD', flag:'🇺🇸', name:'Dollar US', bank:'Federal Reserve',
    rate:'3.50-3.75%', score:0.5,
    bias:'LÉG. HAUSSIER', biasCls:'bt-lhawk',
    keyData:[['PCE/Core','3.0%'],['Fed','3.50-3.75%'],['FOMC','28-29 Juil. · Hold · Hike T4 sur table']],
    pillars:{
    ...
    detail:{
      monetary:{rows:[{k:'Taux actuel',v:'3.50–3.75% (inchangé depuis janv.)'},{k:'Prévision Fed',v:'1 seul cut signalé en 2026',c:'neutral'},{k:'FOMC Avril',v:'Décision 28-29 Juil. · Hold quasi-certain',c:'neutral'},{k:'Marché vs Fed',v:'Price légèrement plus de cuts que Fed',c:'bear'},{k:'PCE/Core PCE',v:'2.7% · Au-dessus cible',c:'bear'}],pr:'Fed en mode attentiste : tient les taux à 3.50-3.75% et ne signale qu\'un seul cut pour 2026. Inflation PCE à 2.7% au-dessus de la cible = pas d\'urgence à couper. FOMC du 29 Avril devrait confirmer le hold.'},
    ...
    pricing:'FOMC 28-29 Juil. → hold attendu · Hike T4 2026 sur table (inflation 3.0% · pétrole $70). DXY ~101 (USD plus fort). Hike Warsh possible Q4 · Cuts reportés 2027-2028.',
    concl:'USD LÉG. HAUSSIER CT : FOMC 28-29 Juil. hold + hike T4 sur table (pétrole $70 · inflation 3.0%). DXY ~101 · rebond. Dédollarisation = frein LT. Haussier CT, surveiller signal Warsh.',
  },
  {
    code:'EUR', flag:'🇪🇺', name:'Euro', bank:'BCE',
    rate:'2.25%', score:0.5,
    bias:'LÉG. HAUSSIER', biasCls:'bt-lhawk',
    keyData:[['HICP 2026','3.0%'],['ECB','2.25%'],['GDP 2026','0.9%']],
    ...
    detail:{
      monetary:{rows:[{k:'Taux actuel',v:'2.25% dépôt · 2.40% refi (hike 11 juin)',c:'bull'},{k:'ECB vs Fed',v:'ECB stable → différentiel favorable EUR',c:'bull'},{k:'Guidance',v:'Pause prolongée · Pas de cut CT',c:'bull'},{k:'Prochain meeting',v:'24 Juillet · Pause attendue',c:'neutral'}],pr:'ECB tient à 2.00% (dépôt) en pause pendant que la Fed est sous pression de couper. Le différentiel se resserre en faveur de l\'EUR. Pas de cut immédiat en vue.'},
      ...
      risk:{rows:[{k:'Rotation hors USD',v:'EUR bénéficiaire principal',c:'bull'},{k:'EUR/USD',v:'~1.140 · Consolidation · Range 1.10-1.15',c:'bull'},{k:'GDP 0.9%',v:'Frein fondamental à l\'upside',c:'bear'},{k:'ECB vs Fed',v:'ECB stable = avantage yield relatif',c:'bull'}],pr:'Rotation hors USD continue à favoriser l\'EUR. ECB stable + incertitude Fed = EUR soutenu. Frein : GDP 2026 à seulement 0.9% limite l\'upside CT.'},
    },
    pricing:'EUR/USD ~1.140 · ECB 2.25% (hike 11 Juin) · Inflation zone € 3.0%. Prochain ECB 24 Juil. GDP 0.9% frein persistant. USD plus fort = frein EUR CT.',
    concl:'EUR NEUTRE/LÉG. HAUSSIER : EUR/USD 1.140 · ECB 2.25% hike juin. USD légèrement haussier = frein EUR CT. GDP 0.9% persistant. Range 1.12-1.16 CT. ECB 24 Juil. = catalyseur.',
  },
  {
    code:'GBP', flag:'🇬🇧', name:'Livre Sterling', bank:'Banque d\'Angleterre',
    rate:'3.75%', score:0.0,
    bias:'NEUTRE', biasCls:'bt-neu',
    keyData:[['BoE','3.75%'],['CPI','2.8%'],['GBP/USD','~1.338']],
    ...
    detail:{
      monetary:{rows:[{k:'Taux actuel',v:'3.75% (hold mai 2026)',c:'bull'},{k:'Prochain vote',v:'7 Août · 85% prob. hold',c:'neutral'},{k:'Signal BoE',v:'CPI 3.0-3.5% empêche cuts immédiats',c:'bull'},{k:'Risque',v:'3/9 membres MPC pro-hike · CPI 2.8%',c:'neutral'}],pr:'BoE à 3.75% maintenu à l\'unanimité en mars. 90% des analystes voient un hold le 30 Avril. CPI 3.0-3.5% empêche tout pivot dovish immédiat. Le taux élevé soutient le GBP mais la croissance est le problème.'},
      inflation:{rows:[{k:'CPI UK fév.',v:'2.8% · Légère détente vs mars',c:'bear'},{k:'Prévision BoE',v:'2.5-3.0% en T3-T4 2026',c:'bear'},{k:'Driver',v:'Énergie (Moyen-Orient) + services',c:'bear'},{k:'Signal',v:'CPI élevé repousse les cuts',c:'bull'}],pr:'CPI à 3.0% en fév., BoE anticipe 3.0-3.5% en T2-T3 2026. L\'énergie est le driver principal. Inflation élevée = BoE ne peut pas couper → paradoxalement supportif GBP.'},
      ...
      risk:{rows:[{k:'Régime',v:'Risk-on · GBP bénéficie',c:'bull'},{k:'GBP/USD',v:'~1.338 · Consolidation post-ceasefire',c:'bull'},{k:'GDP 0.7%',v:'Pire G20 avancé = plafond fondamental',c:'bear'},{k:'BoE 30 Avr.',v:'BoE 7 Août · CPI 2.8% · Hold probable',c:'neutral'}],pr:'GBP tiraillé : taux élevés + USD faible = support · Mais GDP 0.7% + plus forte exposition UK au conflit = frein. NEUTRE avec légère incertitude autour du BoE 30 Avr.'},
    },
    pricing:'GBP/USD ~1.338 · BoE 3.75% hold (vote 7-2) · CPI 2.8% · GDP 2026 0.7% (parmi pires G20 avancé). BoE 30 Juil. prochain meeting.',
    concl:'GBP NEUTRE : GBP/USD 1.338 · BoE 3.75% hold 7-2. USD légèrement haussier = pression GBP. CPI 2.8% · GDP 0.7% = frein fondamental. BoE 30 Juil. = prochain catalyseur.',
  },
  {
    code:'JPY', flag:'🇯🇵', name:'Yen Japonais', bank:'Banque du Japon',
    rate:'1.00%', score:0.5,
    bias:'LÉG. HAUSSIER', biasCls:'bt-lhawk',
    keyData:[['BoJ','1.00% · Hike 16 Juin · Cycle actif'],['USD/JPY','~162'],['Prochain hike','T3-T4 2026']],
    ...
    detail:{
      monetary:{rows:[{k:'Taux actuel',v:'1.00% (hike +25bp 16 juin 2026)',c:'bull'},{k:'Réunion BoJ',v:'16 Juin 2026 · Hike +25bp effectué',c:'neutral'},{k:'Prob. hike Avr.',v:'100% · Hike effectué 16 juin · +25bp',c:'bear'},{k:'Ueda',v:'Hawkish · Données favorables · Cycle actif',c:'bear'},{k:'Juillet',v:'Prochain hike: automne 2026 · Cycle haussier actif',c:'bull'}],pr:'BoJ à 1.00% depuis juin 2026 (max 30 ans). Hike effectué +25bp le 16 juin — prochain en automne 2026 (~10%) suite aux signaux prudents d\'Ueda face aux tensions géopolitiques. Le report à juillet semble désormais le scénario central.'},
      ...
      risk:{rows:[{k:'Carry trade',v:'USD/JPY 160 · Carry actif',c:'bear'},{k:'Hike Avr.',v:'~10% prob. → catalyseur immédiat faible',c:'bear'},{k:'Hike Juillet',v:'Scénario central · Catalyseur à MT',c:'bull'},{k:'Géopolitique',v:'Ceasefire 17 juin · Pression géopo réduite',c:'bear'}],pr:'USD/JPY à 160 = carry trade très tendu. Avec hike avril peu probable (~10%), le catalyseur immédiat disparaît. Hike juillet = scénario central. JPY NEUTRE à CT, haussier à MT.'},
    },
    pricing:'USD/JPY ~162 · BoJ HIKE 16 Juin (+25bp → 1.00%) · Cycle de hausse actif. Carry trade maintient USD/JPY élevé malgré BoJ. Prochain hike T3-T4 2026.',
    concl:'JPY LÉG. HAUSSIER MT : BoJ 1.00% (hike juin confirmé). USD/JPY 162 = carry trade persistant > BoJ hike. Prochain hike T3-T4 = JPY haussier MT. Short USD/JPY = trade à venir.',
  },
  {
    code:'CHF', flag:'🇨🇭', name:'Franc Suisse', bank:'BNS / SNB',
    rate:'0.00%', score:1.0,
    bias:'HAUSSIER', biasCls:'bt-hawk',
    keyData:[['USD/CHF','0.806'],['EUR/CHF','0.920'],['SNB','0.00%']],
    ...
    detail:{
      ...
      risk:{rows:[{k:'Safe haven',v:'CHF = destination principale géopo',c:'bull'},{k:'USD/CHF',v:'0.806 · Rebond post-ceasefire',c:'bull'},{k:'EUR/CHF',v:'0.920 · CHF fort vs EUR aussi',c:'bull'},{k:'Rotation USD',v:'Flux massifs hors USD → CHF',c:'bull'}],pr:'CHF fort même en risk-on = signal exceptionnel. La géopolitique (Moyen-Orient) + rotation hors USD = double catalyseur. USD/CHF à 0.782 = CHF au plus fort depuis des années. SNB débordé.'},
    },
    pricing:'USD/CHF 0.806 · EUR/CHF 0.920 · SNB 0.00% · Inflation 0.5% (plus basse G10). CHF moins fort post-ceasefire mais toujours structurellement haussier.',
    concl:'CHF HAUSSIER : SNB 0.00% · USD/CHF 0.806 (plus bas vs 0.782 Avr. post-ceasefire). Ceasefire réduit flux safe haven CT. Cible 0.78-0.79. Long CHF vs CAD/NZD plus convainquant que vs USD.',
  },
  {
    code:'AUD', flag:'🇦🇺', name:'Dollar Australien', bank:'RBA',
    rate:'4.35%', score:1.5,
    bias:'HAUSSIER', biasCls:'bt-hawk',
    keyData:[['RBA','4.35%'],['AUD/USD','0.694'],['Pic prévu','4.60-4.85%']],
    ...
    pricing:'AUD/USD 0.694 · RBA 4.35% (3 hikes en 2026) → pic 4.60-4.85% · Inflation au-dessus cible · Emploi solide. Hawkish le plus actif du G10.',
    concl:'AUD HAUSSIER : RBA hawkish actif (4.35% · 3 hikes 2026) + emploi solide. AUD/USD 0.694 (USD plus fort comprime AUD). Acheter replis 0.68-0.69. Cible 0.71-0.72. AUD/CAD = meilleure expression.',
  },
  {
    code:'NZD', flag:'🇳🇿', name:'Dollar NZ', bank:'RBNZ',
    rate:'2.25%', score:-1.0,
    bias:'BAISSIER', biasCls:'bt-dov',
    keyData:[['RBNZ','2.25%'],['NZD/USD','0.570'],['Stagflation','CPI 3.1%+ · GDP faible']],
  ...
  },
  {
    ...
    rate:'2.25%', score:-1.0,
    bias:'BAISSIER', biasCls:'bt-dov',
    keyData:[['BOC','2.25% · 5e hold'],['USD/CAD','1.42'],['Prochain','15 Juil. 2026']],
  ...
  },
  {
    ...
    rate:'4.25%', score:1.0,
    bias:'HAUSSIER', biasCls:'bt-hawk',
    keyData:[['NB','4.25% · Hike Mai'],['Brent','$72 · Baisse depuis $95 Avr.'],['Prochain','13 Août 2026']],
    ...
    pricing:'NB 4.25% (hike Mai effectué) · Hold 17 Juin · Pétrole $72 (frein vs $95 Avr.) · Inflation persistante au-dessus cible. Prochain meeting 13 Août.',
    concl:'NOK HAUSSIER : NB 4.25% (hike Mai) + inflation persistante. MAIS pétrole $72 (vs $95 Avr.) = vent de face majeur pour NOK. NOK/SEK reste valide via différentiel taux. Score réduit vs Avril.',
  },
  {
...
let OPPS = [
  {rank:'01',top:true,pair:'AUD/CAD',dir:'BUY',dirCls:'dir-buy',logic:'<strong>RBA hawkish 4.35% vs BOC pause 2.25% · Divergence maximale G10.</strong> RBA = seule grande BC en cycle de hausse actif. BOC : 5e hold consécutif. AUD emploi solide · USD/CAD 1.42 · Chômage CA 6.7%. Trade de divergence de politique monétaire.',spread:'Score diff : <span>AUD +1.5 vs CAD −1.0 = 2.5 pts</span> · Divergence G10 maximale'},
  {rank:'02',top:true,pair:'NZD/AUD',dir:'SELL NZD',dirCls:'dir-sell',logic:'<strong>Stagflation NZ vs RBA hawkish actif.</strong> NZD/USD à 0.570 (faiblesse marquée) · RBNZ 2.25% vs RBA 4.35% · CPI NZ 3.1%+ sur fond GDP faible. AUD : emploi solide + RBA hawkish. Divergence fondamentale claire.',spread:'Score diff : <span>AUD +1.5 vs NZD −1.0 = 2.5 pts</span> · Short NZD/AUD conviction'},
  {rank:'03',top:true,pair:'NOK/SEK',dir:'BUY',dirCls:'dir-buy',logic:'<strong>Norges Bank 4.25% (hike Mai) vs Riksbank 1.75% (pause).</strong> NB a monté en Mai malgré Brent $72. Inflation NO persistante. Riksbank dovish (CPIF 1.1%). Différentiel taux 2.5 pts en faveur NOK.',spread:'Score diff : <span>NOK +1.0 vs SEK −0.5 = 1.5 pts</span> · Meilleur trade Scandi'},
  {rank:'04',top:false,pair:'AUD/USD',dir:'BUY',dirCls:'dir-buy',logic:'<strong>RBA hawkish (4.35%) vs Fed en hold.</strong> AUD/USD 0.694 · RBA seule grande BC en cycle de hausse actif. USD légèrement haussier mais RBA différentiel reste positif. Acheter replis 0.68-0.69.',spread:'Score diff : <span>AUD +1.5 vs USD +0.5 = 1.0 pt</span> · Cible : <span>0.71-0.72</span>'},
  {rank:'05',top:false,pair:'USD/CHF',dir:'SELL',dirCls:'dir-sell',logic:'<strong>CHF safe haven structurel · SNB 0.00%.</strong> USD/CHF 0.806 (vs 0.782 Avr.) · CHF moins fort post-ceasefire. USD légèrement haussier = compression prime CHF. Trade plus modéré vs Avril.',spread:'Score diff : <span>CHF +1.0 vs USD +0.5 = 0.5 pt</span> · Modéré · Cible : <span>0.78-0.79</span>'},
  {rank:'06',top:false,pair:'EUR/GBP',dir:'BUY',dirCls:'dir-buy',logic:'<strong>ECB hawkish (hike Juin → 2.25%) vs BoE pause (3.75%).</strong> ECB en mode hawkish actif (inflation 3.0%) vs BoE en hold (vote 7-2). Dynamique relative en faveur EUR. Prochain ECB 24 Juil.',spread:'Score diff : <span>EUR +0.5 vs GBP 0.0 = 0.5 pt</span> · Modéré · Scénario haussier graduel'},
];
...
let METALS = [
  {
    ...
    rate:'~$4,150', score:2.5,
    bias:'HAUSSIER', biasCls:'bt-hawk',
    keyData:[['Prix','$4,150'],['ATH','$4,830 (2 Avr.)'],['Repli','Post-ceasefire']],
    ...
    detail:{
      ...
      usd:{rows:[{k:'DXY',v:'Neutre · DXY 101 · EUR/USD 1.140',c:'bull'},{k:'Corrélation inverse',v:'USD faible = Or haussier direct',c:'bull'},{k:'Dédollarisation',v:'BC vendent USD, achètent Or',c:'bull'},{k:'USD/CHF',v:'0.781 · Rotation hors USD globale',c:'bull'}],pr:'USD au plus bas (EUR/USD 1.140) = Or bénéficiaire direct. La rotation hors USD est structurelle et profite massivement à l\'Or.'},
    ...
    pricing:'Or $4,150 · Repli depuis ATH $4,830 (Avr.) · Ceasefire 17 Juin = sortie prime géopo. USD plus fort (DXY ~101) = frein. Dédollarisation + achats BC = drivers structurels intacts. ECB 24 Juil / FOMC 28-29 Juil. = prochains catalyseurs.',
    concl:'Or HAUSSIER : repli $4,150 post-ceasefire = zone achat LT. USD fort = frein CT. Acheter replis $4,050-$4,150. Cible MT $4,500-$4,800. Stop $3,800. Ceasefire fragile = risque rebond géopo.',
  },
  {
    code:'SILVER', flag:'🥈', name:'Argent', bank:'OANDA:XAGUSD',
    rate:'~$61', score:2.0,
    bias:'HAUSSIER', biasCls:'bt-hawk',
    keyData:[['Prix','$61'],['Ratio Or/Ag','~68x'],['Repli','Post-ceasefire depuis ATH']],
    ...
    detail:{
      ...
      rates:{rows:[{k:'Taux réels',v:'Même dynamique que l\'Or',c:'bull'},{k:'Baisse attendue Fed',v:'1 cut possible T4 2026 · Modérément supportif',c:'bull'}],pr:'Bénéficie de la même dynamique que l\'Or via les anticipations de baisses Fed 2026.'},
      risk:{rows:[{k:'Régime',v:'RISK-ON · Bénéfique Argent',c:'bull'},{k:'Ratio Or/Ag',v:'~68x · Dans médiane historique 65-75x',c:'neutral'},{k:'Argent vs Or',v:'Légèrement riche vs médianehistorique',c:'neutral'},{k:'Risk-on',v:'Argent surperforme en risk-on',c:'bull'}],pr:'Ratio Or/Argent à 60x = argent légèrement cher vs or par rapport à la médiane historique. Mais en absolu, $79 = ATH + risk-on = momentum très fort.'},
    },
    pricing:'Argent $61 · Repli depuis ATH post-ceasefire. Ratio Or/Ag ~68x. USD fort = frein CT. Driver industriel solaire intact. Acheter $58-62.',
    concl:'Argent HAUSSIER : repli $61 post-ceasefire = zone achat. Driver industriel solaire + dédollarisation intacts. Acheter $58-62. Cible $75-$80. Stop $52.',
  },
  {
    code:'COPPER', flag:'🟫', name:'Cuivre', bank:'COMEX:HG1!',
    rate:'~$6.13/lb', score:2.5,
    bias:'HAUSSIER', biasCls:'bt-hawk',
    keyData:[['Prix','$6.13/lb (~$13,335/MT)'],['YTD','↑ +23%'],['Chine','Demande industrielle soutenue']],
    ...
    detail:{
      ...
      usd:{rows:[{k:'Corrélation USD',v:'Inverse (commodity)',c:'bull'},{k:'USD faible',v:'EUR/USD 1.140 · Modérément supportif cuivre',c:'bull'},{k:'DXY ↓',v:'Boost mécanique des commodités USD',c:'bull'}],pr:'USD au plus bas (EUR/USD 1.140) = boost mécanique majeur pour le cuivre libellé en USD. Driver CT fort.'},
      ...
      risk:{rows:[{k:'Régime',v:'CEASEFIRE FRAGILE · REFLATION',c:'bull'},{k:'Cuivre = "Dr. Copper"',v:'+30% valide thèse croissance globale',c:'bull'},{k:'Signal CT',v:'Breakout majeur · $5.89/lb nouveau range',c:'bull'},{k:'Risque',v:'Récession Chine ou recul demande EV',c:'bear'}],pr:'Cuivre = proxy de la croissance mondiale. La hausse à $5.89/lb (+30% YTD) est le signal le plus clair du régime REFLATION actuel. "Dr. Copper" crie la croissance.'},
    },
    pricing:'Cuivre $6.13/lb (~$13,335/MT) · +23% YoY · Demande industrielle soutenue · PMI Chine >50. Transition EV/solaire = driver structurel. USD légèrement plus fort. Range $5.80-$6.80 REFLATION.',
    concl:'Cuivre HAUSSIER : $6.13 · +23% YoY · Transition énergétique EV/solaire = driver structurel. Momentum solide. Acheter replis $5.80-5.90. Cible $6.80-7.00 MT. Stop $5.50.',
  },
  {
    code:'PLATINUM', flag:'⬜', name:'Platine', bank:'TVC:PLATINUM',
    rate:'~$1,950/oz', score:0.5,
    bias:'LÉG. HAUSSIER', biasCls:'bt-lhawk',
    ...
    detail:{
      ...
      demand:{rows:[{k:'Autocatalyseurs',v:'35% demande · Hybrides ↑ mais lent',c:'neutral'},{k:'Hydrogène',v:'Électrolyse PEM · Driver LT encore marginal',c:'neutral'},{k:'Substitution Or',v:'À $2,093, platine encore accessible vs Or $4,150',c:'bull'},{k:'Déficit 2026',v:'~120,000 oz · Non encore intégré au prix',c:'bull'}],pr:'Déficit structurel existe mais le marché ne l\'intègre pas encore. La demande hydrogène reste un driver de long terme. Substitution bijouterie vs Or = potentiel CT si Or continue ATH.'},
      usd:{rows:[{k:'Corrélation USD',v:'Inverse (commodity)',c:'bull'},{k:'USD faible',v:'EUR/USD 1.140 · Supportif',c:'bull'}],pr:'USD faible = supportif pour le platine. Légèrement positif mais pas le driver principal.'},
...
let METALS_OPPS = [
  {rank:'01',top:true,pair:'GOLD (Long / Zone achat post-ceasefire)',dir:'BUY',dirCls:'dir-buy',logic:'<strong>Or $4,150 · Repli depuis ATH $4,830 (Avr.) · Ceasefire 17 Juin = prise de bénéfices géopo.</strong> Drivers structurels intacts : dédollarisation, achats BC records. Acheter replis $4,050-$4,150. USD plus fort = frein CT.',spread:'Score : <span>+2.5</span> · Cible MT : <span>$4,500-$4,800</span> · Stop : <span>$3,800</span>'},
  {rank:'02',top:true,pair:'COPPER (Long)',dir:'BUY',dirCls:'dir-buy',logic:'<strong>Cuivre $6.13/lb · +23% YoY · Transition énergétique + stimulus Chine PMI >50.</strong> Demande industrielle solide. Hormuz partiel = supply chains normalisent. Momentum haussier maintenu.',spread:'Score : <span>+2.5</span> · Cible MT : <span>$6.80-7.00</span> · Stop : <span>$5.50</span>'},
  {rank:'03',top:false,pair:'SILVER (Long / Zone achat)',dir:'BUY',dirCls:'dir-buy',logic:'<strong>Argent $61 · Repli depuis ATH · Ratio Or/Ag 68x.</strong> Driver industriel solaire intact + dédollarisation. USD fort = frein CT. Acheter $58-62.',spread:'Score : <span>+2.0</span> · Cible : <span>$75-$80</span> · Stop : <span>$52</span>'},
  {rank:'04',top:false,pair:'PLATINUM (Accumulation LT)',dir:'BUY (différé)',dirCls:'dir-buy',logic:'<strong>Platine ~$1,950 · Sous-valorisation extrême.</strong> Ratio Pt/Au à 0.47x (historique ~0.8x). Déficit structurel 120K oz. Hydrogène = driver LT. Accumuler sous $1,900.',spread:'Score : <span>+0.5</span> · Ratio Pt/Au : <span>0.47x</span> · Cible LT : <span>$2,500-$3,000</span>'},
];
...
let ENERGY = [
  {
    ...
    rate:'~$70', score:-0.5,
    bias:'LÉG. BAISSIER', biasCls:'bt-ldov',
    keyData:[['Prix','$70'],['Hormuz','~28% capacité · Ceasefire 17 Juin'],['OPEC+','Hausse quotas +188K bpd/mois']],
    ...
    detail:{
      opec:{rows:[{k:'Hormuz toujours fermé',v:'Ceasefire 17 juin · Accord Versailles · Hormuz ~28% trafic',c:'bear'},{k:'OPEC+ cuts',v:'Hausse 411kb/j Aug · Plancher $65-70 tacite',c:'bull'},{k:'IEA outlook',v:'Surplus offre T3 · Zone équilibre $65-75',c:'bear'},{k:'Iran statement',v:'Accord Versailles · Passage progressivement normalisé',c:'bear'},{k:'Citi scenario',v:'Scénario base $65-75 · Ceasefire tient',c:'bear'}],pr:'CHOC PÉTROLIER MAJEUR : Ormuz toujours fermé (9e semaine). Iran double la mise. Brent pic $128 le 2 Avril. EIA anticipe pic Q2 à $115. Citi: $150 si fermeture jusqu\'en juin.'},
      ...
      usd:{rows:[{k:'Pétrole / USD',v:'Libellé en USD → corrélation inverse',c:'bull'},{k:'EUR/USD 1.178',v:'DXY 101 · EUR/USD 1.140 · Effet modéré',c:'bull'},{k:'DXY ↓↓',v:'Driver positif structurel',c:'bull'}],pr:'USD très faible (EUR/USD 1.140) = boost mécanique pour le pétrole. Seul driver haussier vraiment fort maintenant que la prime géopo. s\'efface.'},
      seasonal:{rows:[{k:'Driving season approche',v:'Juil-août · Pic estival · Demande en cours',c:'bull'},{k:'Raffinage',v:'Marges stables',c:'neutral'}],pr:'Driving season US qui approche = soutien saisonnier. Facteur positif CT mais moins puissant que la prime géopolitique qui disparaît.'},
    },
    pricing:'WTI $70 · Ceasefire 17 Juin · Hormuz ~28% capacité. OPEC+ hausse quotas +188K bpd/mois = pression baissière. Driving season US (juil.-août) = soutien partiel. Range $65-75.',
    concl:'WTI NEUTRE/LÉG. BAISSIER : $70 post-ceasefire · Hormuz ~28% · OPEC+ hausse production. Driving season = soutien CT limité. Éviter longs. Range $65-75. Catalyseur haussier : re-fermeture Hormuz.',
  },
  {
    code:'BRENT', flag:'🛢️', name:'Pétrole Brent', bank:'TVC:UKOIL',
    rate:'~$72', score:-0.5,
    bias:'LÉG. BAISSIER', biasCls:'bt-ldov',
    keyData:[['Prix','$72 · Repli depuis pic $128 (Avr.)'],['Spread vs WTI','+$2 · Normalisé'],['Hormuz','~28% capacité · OPEC+ hausse production']],
    ...
    detail:{
      opec:{rows:[{k:'Hormuz toujours fermé',v:'Ceasefire 17 juin · Accord Versailles fragile · Hormuz ~28%',c:'bear'},{k:'Brent = référence internationale',v:'Prime géopo effondrée · Spread Brent/WTI ~$2',c:'bull'},{k:'Spread Brent/WTI',v:'+$2 · Prime géopo réduite post-ceasefire',c:'bull'},{k:'OPEC+',v:'Hausse production progressive · Plancher $65-70',c:'bull'}],pr:'Brent $72 = repli post-ceasefire. Spread Brent/WTI ~$2 (normalisé vs $11.2 au pic). Hormuz ~28% capacité · OPEC+ hausse production · Accord Versailles 17 Juin.'},
      ...
      usd:{rows:[{k:'USD / Brent',v:'Corrélation inverse classique',c:'bull'},{k:'EUR/USD 1.178',v:'DXY 101 · EUR/USD 1.140 · Soutien modéré',c:'bull'}],pr:'USD très faible (EUR/USD 1.140) = support fort pour Brent libellé en USD. Compense partiellement la perte de prime géopolitique.'},
    ...
    pricing:'Brent $72 · Repli depuis pic $128 (Avr.) · Ceasefire 17 Juin · Hormuz ~28% · OPEC+ hausse quotas. Spread Brent/WTI ~$2 (normalisé). Range $68-78.',
    concl:'Brent NEUTRE/LÉG. BAISSIER : $72 post-ceasefire. Hormuz ~28% = toujours perturbé mais OPEC+ production hausse. Range $68-78. Attendre signal clair avant position. Re-fermeture Hormuz = seul catalyseur haussier fort.',
  },
  {
    code:'NATGAS', flag:'🔥', name:'Gaz Naturel', bank:'TVC:NGAS',
    rate:'~$3.20', score:0.5,
    bias:'LÉG. HAUSSIER', biasCls:'bt-lhawk',
    keyData:[['Prix (Henry Hub)','$3.20'],['Stocks EIA','Proches moy. 5Y'],['Saison','Été · Demande climatisation']],
    ...
    detail:{
      opec:{rows:[{k:'Pipeline russe Europe',v:'Quasi-stoppé · LNG US demandé',c:'bull'},{k:'Ormuz sem. 8',v:'Ceasefire 17 juin · Tension GNL réduite · LNG US stable',c:'bull'},{k:'OPEC Gaz',v:'Pas de cartel équivalent',c:'neutral'}],pr:'L\'Europe cherche alternatives au gaz russe → LNG US = support structurel. Ormuz bloqué = GNL encore plus demandé. Facteur positif MT.'},
      ...
      seasonal:{rows:[{k:'Avril = saison creuse',v:'Juillet = pic clim · Demande en hausse',c:'bear'},{k:'Mai-juin injection',v:'Injection quasi-terminée · Stocks hauts · Clim soutient prix',c:'bear'},{k:'Été (juillet-août)',v:'Demande clim en cours · NatGas $3.20 · Rebond actif',c:'neutral'}],pr:'Pire moment saisonnier : après hiver, avant été. Stocks excédentaires + saison creuse = double pression baissière. Attendre l\'été pour le rebond.'},
    },
    pricing:'Henry Hub $3.20 · Stocks proches moy. 5Y · Demande climatisation été (juil.-août). Rebond saisonnier depuis creux $2.58 (Avr.). Fenêtre haussière estivale. Cible $3.50-3.80.',
    concl:'Gaz Naturel LÉG. HAUSSIER CT : $3.20 · Pic demande climatisation estivale juillet-août. Rebond depuis creux $2.58 (Avr.). Acheter $3.00-3.20. Cible $3.50-3.80. Stop $2.80. Revendre en septembre.',
  },
];

let ENERGY_OPPS = [
  {rank:'01',top:true,pair:'BRENT (Neutre / Surveiller)',dir:'NEUTRE',dirCls:'dir-sell',logic:'<strong>Brent $72 · Ceasefire 17 Juin · Hormuz ~28% capacité · OPEC+ hausse quotas +188K bpd/mois.</strong> Repli de $128 (Avr.) à $72. Tendance baissière CT. Surveiller résistance $75-78. Rebond si Hormuz ferme à nouveau.',spread:'Score : <span>−0.5</span> · Range CT : <span>$68-78</span> · Catalyseur haussier : <span>Fermeture Hormuz</span>'},
  {rank:'02',top:true,pair:'WTI (Neutre / Léger biais baissier)',dir:'NEUTRE',dirCls:'dir-sell',logic:'<strong>WTI $70 · Post-ceasefire + OPEC+ production hausse.</strong> Driving season US (juil.-août) = soutien partiel mais OPEC+ pèse. Range probable $65-75. Éviter longs sans catalyseur.',spread:'Score : <span>−0.5</span> · Range : <span>$65-75</span> · Stop si long : <span>$62</span>'},
  {rank:'03',top:false,pair:'NAT GAS (Long / Été)',dir:'BUY',dirCls:'dir-buy',logic:'<strong>Henry Hub $3.20 · Pic demande climatisation (juil.-août).</strong> Stocks proches moy. 5Y. Rebond saisonnier depuis creux printanier $2.58. Fenêtre achat juillet-août.',spread:'Score : <span>+0.5</span> · Cible : <span>$3.50-3.80</span> · Stop : <span>$2.80</span>'},
];
...
let INDICES = [
  {
    ...
    rate:'~7,537', score:2.0,
    bias:'HAUSSIER', biasCls:'bt-hawk',
    keyData:[['Niveau','7,537 ATH'],['P/E fwd','~26x'],['FOMC','28-29 Juil. · Hold attendu']],
    pillars:{policy:{score:2.0,wt:'25%'},macro:{score:1.5,wt:'25%'},earnings:{score:1.0,wt:'20%'},flows:{score:2.0,wt:'15%'},risk:{score:1.5,wt:'15%'}},
    detail:{
      policy:{rows:[{k:'Fed Funds',v:'3.50-3.75% · Hold · Pas de cut en 2026 à ce stade',c:'bull'},{k:'Cuts Fed 2026',v:'Hold confirmé · 1 cut envisagé T4 2026 si inflation baisse',c:'bull'},{k:'Fed pivot',v:'USD neutre DXY 101 · Taux réels stables',c:'bull'}],pr:'Fed en cycle de baisse (3.50-3.75%) = taux réels en baisse = valorisations soutenues. USD faible = pas de pression sur les bénéfices des multinationales. Régime monétaire accommodant.'},
      ...
      risk:{rows:[{k:'VIX',v:'~15 · Risk-on · Complacency',c:'bull'},{k:'Régime',v:'CEASEFIRE FRAGILE · REFLATION',c:'bull'},{k:'Risque correction',v:'P/E 26x = vulnérable à surprise hawkish',c:'bear'},{k:'Iran ceasefire',v:'Pétrole $88.8 · Pression marges réduite',c:'bull'}],pr:'VIX bas = confiance du marché. Détente Iran → pétrole en baisse = marges améliorées. Risque : Fed hawkish surprise. Tant que le régime REFLATION tient et pétrole < $95, biais haussier.'},
    },
    pricing:'S&P 7,537 ATH · REFLATION + EPS solides T2 + FOMC 28-29 Juil. hold attendu. Pétrole $70 = soulagement marges. VIX bas = risk-on. Support 7,250. Cible CT 7,700-7,900.',
    concl:'S&P 500 HAUSSIER : ATH 7,537 · REFLATION + EPS forts T2 + FOMC hold Juil. Pétrole $70 = soulagement marges. Acheter replis 7,250-7,300. Stop 7,000.',
  },
  {
    code:'NASDAQ', flag:'🇺🇸', name:'Nasdaq 100', bank:'FOREXCOM:NSXUSD',
    rate:'~27,100', score:2.5,
    bias:'TRÈS HAUSSIER', biasCls:'bt-hawk',
    keyData:[['Niveau','27,100'],['P/E fwd','~31x'],['MAG7','Monétisation IA · EPS records T2']],
    pillars:{policy:{score:2.5,wt:'25%'},macro:{score:1.5,wt:'20%'},earnings:{score:2.0,wt:'25%'},flows:{score:2.0,wt:'15%'},risk:{score:1.5,wt:'15%'}},
    detail:{
      policy:{rows:[{k:'Fed dovish',v:'Hold 3.50-3.75% · Pas de hike = supportif tech',c:'bull'},{k:'Taux réels ↓',v:'Stabilisés · Valorisations soutenues · IA = croissance',c:'bull'},{k:'USD faible',v:'Tech = revenus mondiaux · USD faible boost',c:'bull'}],pr:'Triple soutien tech : Fed dovish + taux réels en baisse + USD faible. Environnement idéal pour la tech à high-multiple. Re-rating de toute la catégorie.'},
    ...
    pricing:'NQ ~27,100 · Monétisation IA accélérée · EPS MAG7 records T2 2026. FOMC 28-29 Juil. = hold attendu. Support 26,000. Cible MT 28,000-29,000.',
    concl:'Nasdaq TRÈS HAUSSIER : ~27,100 · Supercycle IA + monétisation concrète + EPS MAG7 records. Plus fort momentum marché. Acheter replis 26,000-26,400. Stop 25,000.',
  },
  {
    code:'DAX 40', flag:'🇩🇪', name:'DAX 40', bank:'FOREXCOM:DEU40',
    rate:'~25,828', score:1.5,
    bias:'HAUSSIER', biasCls:'bt-hawk',
    keyData:[['Niveau','25,828'],['P/E fwd','~15x'],['ECB','2.25% · Hike Juin · Zeitenwende']],
    pillars:{policy:{score:2.5,wt:'25%'},macro:{score:0.5,wt:'25%'},earnings:{score:1.0,wt:'20%'},flows:{score:2.0,wt:'15%'},risk:{score:1.0,wt:'15%'}},
    detail:{
      policy:{rows:[{k:'BCE',v:'2.25% · Neutre · Pause post-hike juin',c:'bull'},{k:'EUR/USD 1.178',v:'EUR/USD 1.140 · Impact modéré imports',c:'neutral'},{k:'Stimulus fiscal DE',v:'Zeitenwende · Infrastructure · Défense',c:'bull'}],pr:'BCE à 2.00% (accommodant) + stimulus fiscal massif allemand (Zeitenwende 2026 = 100Mrd€ défense + infrastructure) = soutien monétaire ET fiscal. Régime de politique idéal.'},
      ...
      flows:{rows:[{k:'Flux étrangers vers DAX',v:'Rotation hors US vers Europe',c:'bull'},{k:'USD faible',v:'EUR/USD 1.140 = Europe attractif $ terms',c:'bull'}],pr:'Rotation globale hors USD vers Europe. DAX bénéficie doublement : rotation Europe + stimulus fiscal. Flux forts.'},
    ...
    pricing:'DAX 25,828 · ATH. Pétrole $72 = soulagement coûts industrie. BCE 2.25% + Zeitenwende. EUR/USD 1.140. Support 25,000. Cible 26,500-27,000.',
    concl:'DAX HAUSSIER : 25,828 · BCE 2.25% + Zeitenwende + défense. Pétrole $72 = soulagement industrie. Acheter replis 25,000-25,200. Stop 24,000. Secteur défense (Rheinmetall) = driver CT.',
  },
  {
    code:'NIKKEI', flag:'🇯🇵', name:'Nikkei 225', bank:'FOREXCOM:JPN225',
    rate:'~69,737', score:2.5,
    bias:'HAUSSIER', biasCls:'bt-hawk',
    keyData:[['Niveau','69,737 (+38.5% YTD)'],['BoJ','1.00% · Cycle de hausse actif'],['USD/JPY','~162 · Carry persistant']],
    pillars:{policy:{score:3.0,wt:'25%'},macro:{score:2.5,wt:'25%'},earnings:{score:2.5,wt:'20%'},flows:{score:2.0,wt:'15%'},risk:{score:2.0,wt:'15%'}},
    detail:{
      policy:{rows:[{k:'BoJ 28 Avr.',v:'HIKE +25bp 16 juin · BoJ 1.00% · Cycle hausse actif',c:'neutral'},{k:'Inflation BoJ',v:'Core CPI 2.8% · Stable · Post-ceasefire',c:'bear'},{k:'USD/JPY',v:'~162 · Carry trade actif · Yen faible malgré hike',c:'neutral'},{k:'Croissance BoJ',v:'GDP FY2026 coupé à 0.5% (vs 1%)',c:'bear'}],pr:'BoJ HOLD confirmé (6-3) mais signal hawkish : 3 membres dissidents pro-hike. Inflation révisée à 2.8%. USD/JPY retombe vers 158 (JPY légèrement fort). Growth coupé à 0.5% = argument contre hike immédiat.'},
      ...
      earnings:{rows:[{k:'EPS exportateurs',v:'USD/JPY 162 = profits excellents Toyota, Sony',c:'bull'},{k:'P/E fwd Nikkei',v:'~18x · Raisonnable vs US',c:'bull'},{k:'Révisions EPS',v:'En forte hausse · Shunto + FX',c:'bull'},{k:'Corporate governance',v:'TSE reform · ROE improvement',c:'bull'}],pr:'USD/JPY 162 = exportateurs japonais au pic de profitabilité. EPS en forte révision à la hausse. Corporate governance reform (TSE) = re-rating structurel. Valorisation encore raisonnable.'},
    ...
    pricing:'Nikkei 69,737 (+38.5% YTD) · BoJ 1.00% (hike 16 Juin) · USD/JPY ~162 · Carry trade soutient exportateurs. TSE reform + Berkshire encore actif. Support 67,000. Cible 72,000-75,000.',
    concl:'Nikkei HAUSSIER : 69,737 (+38.5% YTD, meilleur indice majeur). BoJ 1.00% = hike graduel. USD/JPY 162 = exportateurs profitables. Acheter replis 67,000-68,000. Stop 65,000. Surveiller USD/JPY.',
  },
  {
    code:'CAC 40', flag:'🇫🇷', name:'CAC 40', bank:'FOREXCOM:FRA40',
    rate:'~8,700', score:1.0,
    bias:'HAUSSIER', biasCls:'bt-hawk',
    keyData:[['Niveau','8,700'],['P/E fwd','~14x'],['LVMH','Chine solide · Pétrole $72 = soulagement']],
    pillars:{policy:{score:2.0,wt:'25%'},macro:{score:0.5,wt:'25%'},earnings:{score:0.5,wt:'20%'},flows:{score:1.0,wt:'15%'},risk:{score:0.5,wt:'15%'}},
    detail:{
      policy:{rows:[{k:'BCE 2.00%',v:'2.25% · Neutre · Pause post-hike juin',c:'bull'},{k:'EUR/USD 1.178',v:'EUR/USD 1.140 · Mixte · Mieux qu\'à 1.178',c:'neutral'}],pr:'BCE à 2.00% = accommodant = support valorisations. EUR fort = légère pression compétitivité exportateurs mais signe de confiance en zone euro.'},
      ...
      flows:{rows:[{k:'Rotation hors USD',v:'EUR/USD 1.140 = Europe attractif',c:'bull'},{k:'Value vs Growth',v:'CAC = value · Bénéficie de la rotation',c:'bull'}],pr:'Rotation globale vers l\'Europe (USD faible) = flux entrants CAC. Valorisations attractives vs US attirent les réallocations.'},
    ...
    pricing:'CAC ~8,700 · BCE 2.25% + LVMH Chine solide · Pétrole $72 = soulagement France (importatrice nette). Support 8,400. Cible 9,000-9,200.',
    concl:'CAC HAUSSIER : ~8,700 · BCE 2.25% + LVMH solide + Pétrole $72 = vent favorable. Acheter replis 8,400-8,500. Stop 8,000. Secteur luxe (LVMH) = baromètre Chine.',
  },
  {
    code:'FTSE 100', flag:'🇬🇧', name:'FTSE 100', bank:'FOREXCOM:UK100',
    rate:'~10,900', score:0.5,
    bias:'LÉG. HAUSSIER', biasCls:'bt-lhawk',
    keyData:[['Niveau','10,900'],['Div. Yield','3.5%'],['Shell/BP','Brent $72 vs pic $128 · Or $4,150']],
    pillars:{policy:{score:1.5,wt:'25%'},macro:{score:1.0,wt:'25%'},earnings:{score:2.0,wt:'20%'},flows:{score:1.5,wt:'15%'},risk:{score:1.5,wt:'15%'}},
    detail:{
      policy:{rows:[{k:'BoE',v:'3.75% · Hold · Pause cycle',c:'bull'},{k:'GBP/USD 1.32',v:'GBP/USD 1.338 · Revenus étrangers en £ = atténués',c:'neutral'},{k:'BoE dovish',v:'Cuts = support indirect valorisations',c:'bull'}],pr:'BoE en cycle baissier (3.75%) = valorisations soutenues. GBP fort (1.32) = légère pression sur la traduction des revenus étrangers. Mais BoE dovish = support net positif.'},
      macro:{rows:[{k:'UK GDP 2026',v:'+1.4% · Amélioration',c:'bull'},{k:'Composition FTSE',v:'40% énergie/mines/financières',c:'bull'},{k:'GBP/USD 1.32',v:'GBP/USD 1.338 · Force macro UK',c:'bull'}],pr:'FTSE bénéficie de sa composition défensive : 40% en énergie, mines, financières. Moins tech = moins volatil. GDP UK en amélioration.'},
      earnings:{rows:[{k:'P/E fwd FTSE',v:'~13x · Très attractif vs monde',c:'bull'},{k:'Dividend yield',v:'3.5% · Attractif',c:'bull'},{k:'Shell/BP',v:'WTI $70 · Baisse significative vs T1 · Pression marges',c:'neutral'},{k:'Rio Tinto/BHP',v:'Or $4,150 + Cuivre $6.13/lb · Profits élevés',c:'bull'}],pr:'Composition mixte : Shell/BP légèrement affectés par la baisse du WTI ($88.8 vs $95) mais Rio/BHP bénéficient de Or ATH $4,830 et Cuivre +30% ($5.89/lb). P/E 13x + 3.5% yield = meilleur rapport qualité/prix des marchés développés.'},
      flows:{rows:[{k:'Flux value',v:'FTSE = value pur · Réallocation globale',c:'bull'},{k:'Dividend hunters',v:'3.5% + GBP/USD 1.338 = attractif',c:'bull'}],pr:'Double attractivité : yield élevé + potentiel hausse. GBP fort = rendement en EUR/USD encore plus attractif pour étrangers.'},
    ...
    pricing:'FTSE ~10,900 · Shell/BP = Brent $72 (marges réduites vs pic $128) · Rio/BHP = Or $4,150 + Cuivre $6.13. Composition value toujours attractive. P/E 13x + yield 3.5%. Support 10,500. Cible 11,200-11,500.',
    concl:'FTSE LÉG. HAUSSIER : ~10,900 · Shell/BP = Brent $72 (marges réduites post-ceasefire) · Rio/BHP = Or $4,150 + Cuivre $6.13. Composition value. P/E 13x + yield 3.5%. Acheter replis 10,100.',
  },
];

let INDICES_OPPS = [
  {rank:'01',top:true,pair:'NIKKEI (Long)',dir:'BUY',dirCls:'dir-buy',logic:'<strong>69,737 (+38.5% YTD) · BoJ 1.00% · Cycle de hausse actif.</strong> USD/JPY ~162 · Carry trade profite exportateurs · Shunto +5.8% · TSE reform. Meilleur indice DM sur 2026.',spread:'Score : <span>+2.5</span> · Niveau : <span>69,737</span> · Cible : <span>72,000-75,000</span>'},
  {rank:'02',top:true,pair:'NASDAQ (Long)',dir:'BUY',dirCls:'dir-buy',logic:'<strong>~27,100 · Monétisation IA concrète · FOMC hold + EPS MAG7 records T2.</strong> MAG7 beats records. 31x P/E justifié +20% EPS. Beta 1.35 = amplificateur RISK-ON.',spread:'Score : <span>+2.5</span> · Niveau : <span>27,100</span> · Cible : <span>28,500-29,000</span>'},
  {rank:'03',top:false,pair:'FTSE (Long)',dir:'BUY',dirCls:'dir-buy',logic:'<strong>~10,900 · P/E 13x + Div. 3.5% · Composition value.</strong> Brent $72 = marges Shell/BP réduites vs pic mais Or $4,150 + Cuivre $6.13 soutiennent Rio/BHP. Meilleur rapport qualité/prix Europe.',spread:'Score : <span>+0.5</span> · Dividend : <span>3.5%</span> · P/E : <span>~13x</span>'},
  {rank:'04',top:false,pair:'DAX (Long)',dir:'BUY',dirCls:'dir-buy',logic:'<strong>25,828 · BCE 2.25% + Zeitenwende fiscal + Pétrole $72 = soulagement.</strong> Secteur défense (Rheinmetall) driver CT. Pétrole plus bas = industrie allemande respire. Long DAX vs NQ = pair trade value/growth.',spread:'Score : <span>+1.5</span> · Niveau : <span>25,828</span> · Cible : <span>26,500-27,000</span>'},
];
...
let CRYPTO = [
  {
    ...
    detail:{
      macro:{rows:[{k:'Rebond $79K',v:'Récupération depuis $74K · Correction ralentit',c:'neutral'},{k:'Décorrélation SPX',v:'BTC −38% ATH / S&P +ATH = paradoxe partiel',c:'neutral'},{k:'Régime crypto',v:'BTC en correction mid-cycle · Potentielle base',c:'neutral'},{k:'USD très faible',v:'EUR/USD 1.140 · Modérément supportif BTC',c:'bull'},{k:'Or digital vs Or',v:'Or $4,150 · BTC rebond = narratif de rattrapage',c:'neutral'}],pr:'BTC rebondit vers $79K depuis le bas de $74K. La correction mid-cycle ralentit. USD très faible + Or ATH = environnement favorable qui commence à soutenir BTC. Correction typique de milieu de cycle post-halving : -38% depuis le pic, potentiellement proche du fond.'},
...
/* ── DATE ── */
document.getElementById('update-date').textContent = '7 Juillet 2026';
